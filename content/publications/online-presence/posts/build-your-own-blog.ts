...
The documentation is this site's other publication, written for exactly this: [Working with the platform](/blog-platform-docs/working-with-the-platform) maps it, and seventeen posts cover writing, extending, theming, and operating it. It is the same documentation I use to run this blog, which is the only kind worth trusting.
