          ...
          return (
            ...
            >
              <button
                ...
                className={cn(
                  "group relative block w-full min-w-0 overflow-hidden rounded-xl bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none",
                  layout === "quilted" &&
